...
_main PROC
	push dword PTR 17
	push dword PTR OFFSET pokaz ; adres obszaru pamiêci
	push dword PTR 1;
	call __write ; odczytywanie znaków z klawiatury
	add esp,12
	...
	mov ebx,eax ;reszta
	call wczytaj_do_EAX
	mov ecx,eax  ;ile liczb
	call wczytaj_do_EAX ;w eax obecny wyraz
	petla:
	call wyswietl_EAX
	add eax,ebx
	loop petla
