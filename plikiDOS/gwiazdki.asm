...
add cs:ile_kolumn,2 ; bo trzeba ominac kod ascii i kolor
mov bx, 320 
add bx, cs:ile_kolumn
...
ile_kolumn dw 0 ;liczba kolumn ekranu
licznik_przerwan dw 0 ;licznik przerwań zegarowych
