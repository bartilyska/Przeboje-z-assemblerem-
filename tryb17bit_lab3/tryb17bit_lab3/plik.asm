...
wyswietl_EAX_17 PROC
	...
	wyswietl:
		...
		push OFFSET znaki ; adres ci¹gu znaków stanowi¹cych nag³ówek komunikatu
		push OFFSET znaki ; adres ci¹gu znaków stanowi¹cych treœæ komunikatu
		push 0 ; uchwyt
		...
		push 0 ; parameter uType
		push OFFSET ciag ; adres ci¹gu znaków stanowi¹cych nag³ówek komunikatu
		push OFFSET ciag ; adres ci¹gu znaków stanowi¹cych treœæ komunikatu
		push 0 ; uchwyt
